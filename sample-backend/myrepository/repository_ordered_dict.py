...
class RepositoryOrderedDict(AbstractRepository):
    ...
    def search(self, query: str) -> list[dict]:
        """
        This method returns searches 'query' string titles of entities
            and returns all entities with matching titles.
        :return: if algorithm found anything, then it returns a list with entities, otherwise it returns [].
        """
        entities_list = list(self.__db.values())
        result = []
